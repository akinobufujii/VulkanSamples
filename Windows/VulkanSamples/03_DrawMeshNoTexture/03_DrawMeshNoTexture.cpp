...
static LPCTSTR	CLASS_NAME = TEXT("03_DrawMeshNoTexture");	// ウィンドウネーム
static LPCSTR APPLICATION_NAME = "03_DrawMeshNoTexture";	// アプリケーション名
...
bool createResource()
{
	...
	shaderStageCreateInfo[0].module = loadShader("mesh.vert.spv", g_VulkanDevice, VK_SHADER_STAGE_VERTEX_BIT);
	...
	shaderStageCreateInfo[1].module = loadShader("mesh.frag.spv", g_VulkanDevice, VK_SHADER_STAGE_FRAGMENT_BIT);
